...
//               className="w-full  no-spinner border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500"
//             />
//           </div>
  ...
  return (
    <div className="w-2/3 mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white shadow-md rounded-lg p-6 sm:p-8 text-gray-900">
                ...
                <div key={field}>
                  <label className="block font-medium text-sm sm:text-base mb-1">
                    {field === "accountHolder" ? "Account Holder Name" :
                      ...
                      field === "ifscCode" ? "IFSC Code" : "Bank Name"}
                  </label>
                  <input
                    type="text"
                    name={field}
        ...
        {message && (
          <p className={`mt-5 text-center text-sm font-medium ${message.includes("success") ? "text-green-600" : "text-red-600"}`}>
            {message}
          </p>
        )}
      </div>
